...
func (s *MCPServer) scanPorts(args map[string]interface{}) (string, error) {
	...
	portsArg := "21,22,23,25,53,80,110,111,135,139,143,222,443,445,993,995,1099,1433,1521,2049,2222,3000,3306,3389,5000,5432,5601,5900,6379,8080,8081,8082,8083,8084,8085,8086,8087,8088,8443,9000,9001,9200,22022,22222,27017,50051"
...
func identifyService(port int) string {
	services := map[int]string{
		21: "ftp", 22: "ssh", 23: "telnet", 25: "smtp", 53: "dns", 222: "ssh",
		...
		9200: "elasticsearch", 22022: "ssh", 22222: "ssh", 27017: "mongodb", 50051: "grpc",
		389: "ldap", 636: "ldaps",
	}
